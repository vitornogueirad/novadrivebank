...
#Feature Engineering
df['proporcaosolicitadatotal'] = df['valorsolicitado'] / df['valortotalbem']
df['proporcaosolicitadatotal'] = df['proporcaosolicitadatotal'].astype(float)
...
X_test = save_scalers(X_test, ['tempoprofissao','renda','idade',
                               'dependentes','valorsolicitado','valortotalbem','proporcaosolicitadatotal'])
...
X_train = save_encoders(X_train, ['profissao', 'tiporesidencia', 
                                  'escolaridade','score','estadocivil','nomecomercial'])
